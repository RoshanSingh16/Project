...
model = pickle.load(open(r'/Users/roshansingh/Desktop/A VS CODE/13.MACHINE LEARNING/6.REGRESSION/1.LINEAR REGRESSION/SIMPLE LRS/Salary Prediction/linear_regression_model.pkl','rb'))
...
if st.button("Predict Salary"):
    ...
    prediction = model.predict(experience_input) # MOST IMPORTANT LINE 
...
#cd "/Users/roshansingh/Desktop/A VS CODE/13.MACHINE LEARNING/6.REGRESSION/1.LINEAR REGRESSION/SIMPLE LRS/Salary Prediction"
